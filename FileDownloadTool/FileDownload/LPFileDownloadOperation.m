...
const NSTimeInterval kCalculateSpeedTime = 2000;
...
- (void)URLSession:(NSURLSession *)session downloadTask:(NSURLSessionDownloadTask *)downloadTask didFinishDownloadingToURL:(NSURL *)location {
    ...
    _downloadModel.locationURL = location;
    [_downloadModel updateItem];
...
//    return [_directorPath stringByAppendingString:_fileName];
//}
//
////temp file path
//- (NSString *)tempFilePath {
//    return [_directorPath stringByAppendingString:_tempFileName];
//}

//- (void)changeToRealFileNameFrome:(NSString *)location {
//    NSFileManager *fileManager = [NSFileManager defaultManager];
//    if([fileManager fileExistsAtPath:location isDirectory:NULL]){
//        [fileManager moveItemAtPath:location toPath:[self finishFilePath] error:NULL];
//    }
//}
